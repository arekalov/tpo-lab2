...
### Рекалов Артём Олегович, вариант 4356726 (базовая функция cos)
...
4. Для КАЖДОГО модуля должны быть реализованы табличные заглушки. При этом, необходимо найти область допустимых значений функций, и, при необходимости, определить взаимозависимые точки в модулях. *(В рамках курса: подмена модулей в автотестах — через **Mockito**; сами «табличные» значения для моков — см. доп. требования ниже.)*
